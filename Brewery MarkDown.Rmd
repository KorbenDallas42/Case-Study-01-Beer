...
Here is our scatter plot a regression line which comes from "geom_smooth(method = lm)"
```{r}
...
With a p value of 2.2e-16 we can say we should reject the null hypothesis that the intercept is 0 which is further proved by the confidence interval being .64 to .69 at 95%. Also the r-squ correlation is .6706 squared = .45 which is a fairly strong relationship. It's safe to say that as you increase either ABV or IBU the other will increase as well. 