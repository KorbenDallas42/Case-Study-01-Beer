...
This code looks at the breweris data set and counts each row within the data set by state column and returns a count of how often each state appears. Since each row is a unique brewery this will tell us how many breweries we have in each state in our data set. 
```{r}
